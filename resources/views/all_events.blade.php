...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/all_events.css') }}">
    ...
    <div class="wrapper">
        ...
        <main>
            <section class="events">
                ...
                <div class="card-info">
                    <div class="cardtxt">
                        <img src="{{ asset('img/all_events/25.svg') }}" class="date-image">
                        <div class="info">
                ...
                <div class="events2">
                    ...
                    <div class="event2" id="conversation-club">
                        <div class="cardtxt2">
                            <img src="{{ asset('img/all_events/club.svg') }}">
                    ...
                    <div class="event2" id="webinars">
                        <div class="cardtxt2">
                            <img src="{{ asset('img/all_events/comp.svg') }}">
                    ...
                    <div class="event2" id="travel-english">
                        <div class="cardtxt2">
                            <img src="{{ asset('img/all_events/map.svg') }}">
                ...
                <div class="events3">
                    ...
                    <div class="event3" id="literature-evenings">
                        <img src="{{ asset('img/all_events/literature.svg') }}">
                        <div class="cardtxt3">
                ...
                <div class="events4">
                    ...
                    <div class="event4" id="movies">
                        <div class="cardtxt4">
                            <img src="{{ asset('img/all_events/video.svg') }}">
                    ...
                    <div class="event4" id="everyday-english">
                        <div class="cardtxt4">
                            <img src="{{ asset('img/all_events/letter.svg') }}">
                    ...
                    <div class="event4" id="writing-workshop">
                        <div class="cardtxt4">
                            <img src="{{ asset('img/all_events/pan.svg') }}">
...
<!-- FOOTER -->
        ...
        <footer>
            <div class="wrapper">
                <div class="info_f">
                    <img src="{{ asset('img/main/logo_white.svg') }}" alt="">
                    <p>8 800 555-35-35</p>
