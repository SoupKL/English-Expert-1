...
<section class="level">
        ...
        <div class="card_level" id="levelC2">
          <img src="{{ asset('/img/cours/levelC2.svg') }}" alt="">
        </div>
        ...
        <div class="purposes">
            ...
            <div class="purposes_right">
                ...
                <div class="purposes_card">
                  ...
                  <h3>Цель 1</h3>
                    <p>Полное владение грамматикой и лексикой на
                        уровне носителя языка</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_2.svg')}}" alt="">
                  <h3>Цель 2</h3>
                    <p>Развитие навыков критического
                        мышления и анализа текстов</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_3.svg')}}" alt="">
                  <h3>Цель 3</h3>
                    <p>Уверенное общение на любые темы, включая
                        специализированные области</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_4.svg')}}" alt="">
                  <h3>Цель 4</h3>
                    <p>Подготовка к написанию высококачественных
...
<section class="photo">
    <div class="wrapper">
      ...
      <img src="{{ asset('img/cours/photoA1.svg')}}" alt="">
...
<div class="wrapper">
    <section class="content">
        ...
        <div class="content_left">
            ...
            <p>Грамматика: все аспекты языка на уровне носителя.<br>
                Лексика: специализированные области (наука, техника, искусство и т.д.).<br>
                Устная практика: сложные дискуссии, лекции, презентации.<br>
                Чтение: сложные литературные и научные тексты.<br>
                Письмо: написание высококачественных научных и профессиональных текстов.<p>
