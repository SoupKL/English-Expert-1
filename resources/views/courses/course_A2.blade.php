...
<section class="level">
        ...
        <div class="card_level" id="levelA2">
            <img src="{{ asset('/img/cours/levelA2.svg') }}" alt="">
        </div>
        ...
        <div class="purposes">
            ...
            <div class="purposes_right">
                <div class="purposes_card">
                    ...
                    <h3>Цель 1</h3>
                    <p>Расширение базовой лексики и грамматики
                        для более уверенной повседневной коммуникации</p>
                </div>

                <div class="purposes_card">
                    <img src="{{ asset('img/cours/purpose_2.svg')}}" alt="">
                    <h3>Цель 2</h3>
                    <p>Развитие навыков чтения и понимания
                        текстов средней сложности</p>
                </div>

                <div class="purposes_card">
                    <img src="{{ asset('img/cours/purpose_3.svg')}}" alt="">
                    <h3>Цель 3</h3>
                    <p>Улучшение устной речи для
                        общения в разнообразных ситуациях: магазины,
                        рестораны, общественный транспорт</p>
                </div>

                <div class="purposes_card">
                    <img src="{{ asset('img/cours/purpose_4.svg')}}" alt="">
                    <h3>Цель 4</h3>
                    <p>Подготовка к письменным коммуникациям:
                        написание писем, сообщений, заметок</p>
                </div>
...
<section class="photo">
    <div class="wrapper">
        ...
        <img src="{{ asset('img/cours/photoA2.svg') }}" alt="">
...
<div class="wrapper">
    <section class="content">
        ...
        <div class="content_left">
            ...
            <p>Грамматика: сложные времена, согласование времен, предлоги, более сложные части речи.<br>
                Лексика: профессии, транспорт, здоровье, погода и т.д.<br>
                Устная практика: диалоги на темы повседневной жизни, ролевые игры.<br>
                Чтение: тексты средней длины, адаптированные материалы, упражнения по чтению и пониманию текста.<br>
                Письмо: написание писем, эссе, заполнение форм.</p>
    ...
    <div class="container">
        ...
        <div class="faq-section">
            <details>
                ...
                <p>Этот курс идеально подходит для тех, кто уже имеет
                    базовые знания английского языка и хочет
                    продолжить свое обучение, расширяя свой
                    словарный запас и улучшая навыки в понимании и
                    общении на простых темах.
                </p>
            </details>
            <details>
