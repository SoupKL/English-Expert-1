...
<section class="level">
        ...
        <div class="card_level" id="levelB2">
          <img src="{{ asset('/img/cours/levelB2.svg') }}" alt="">
        </div>
        ...
        <div class="purposes">
            ...
            <div class="purposes_right">
                ...
                <div class="purposes_card">
                  ...
                  <h3>Цель 1</h3>
                    <p>Глубокое понимание и использование
                        сложной грамматики и лексики</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_2.svg')}}" alt="">
                  <h3>Цель 2</h3>
                    <p> Развитие навыков критического чтения и
                        анализа текстов</p>
                </div>
                ...
                <div class="purposes_card">
                  ...
                  <h3>Цель 3</h3>
                    <p> Уверенное общение на профессиональные
                        и академические темы</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_4.svg')}}" alt="">
                  <h3>Цель 4</h3>
                    <p> Подготовка к написанию сложных
                        научных и профессиональных текстов</p>
                </div>
...
<section class="photo">
    <div class="wrapper">
      ...
      <img src="{{ asset('img/cours/photoB2.svg')}}" alt="">
...
<div class="wrapper">
    <section class="content">
        ...
        <div class="content_left">
            ...
            <p>Грамматика: сложные времена, фразовые глаголы, идиомы.<br>
                Лексика: юриспруденция, медицина, инженерия, философия и т.д.<br>
                Устная практика: дебаты, презентации, переговоры.<br>
                Чтение: научные статьи, литературные произведения, документы.<br>
                Письмо: написание диссертаций, статей, обзоров.</p>
    ...
    <div class="container">
        ...
        <div class="faq-section">
            <details>
                ...
                <p>Этот курс идеально подходит для тех, кто уже владеет
                    английским языком на уровне выше среднего и готов к
                    изучению более сложных аспектов языка, включая
                    академические и профессиональные навыки.</p>
            </details>
            <details>
