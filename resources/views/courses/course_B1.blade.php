...
<section class="level">
        ...
        <div class="card_level" id="levelB1">
          <img src="{{ asset('/img/cours/levelB1.svg') }}" alt="">
        </div>
        ...
        <div class="purposes">
            ...
            <div class="purposes_right">
                ...
                <div class="purposes_card">
                  ...
                  <h3>Цель 1</h3>
                    <p>Углубление знаний грамматики и
                        лексики для уверенного общения</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_2.svg')}}" alt="">
                  <h3>Цель 2</h3>
                    <p>Развитие навыков чтения и анализа текстов</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_3.svg')}}" alt="">
                  <h3>Цель 3</h3>
                    <p>Развитие навыков свободного
                        устного общения на различные темы</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_4.svg')}}" alt="">
                  <h3>Цель 4</h3>
                    <p>Подготовка к написанию сложных текстов и документов</p>
                </div>
...
<section class="photo">
    <div class="wrapper">
      ...
      <img src="{{ asset('img/cours/photoB1.svg')}}" alt="">
...
<div class="wrapper">
    <section class="content">
        ...
        <div class="content_left">
            ...
            <p>Грамматика: условные предложения, страдательный залог, модальные глаголы.<br>
                Лексика: экономика, культура, спорт, технологии и т.д.<br>
                Устная практика: обсуждение новостей, презентации, дебаты.<br>
                Чтение: статьи, рассказы, учебные материалы.<br>
                Письмо: написание эссе, отчётов, официальных писем.</p>
    ...
    <div class="container">
        ...
        <div class="faq-section">
            <details>
                ...
                <p>Этот курс идеально подходит для тех, кто хочет
                    уверенно общаться на английском языке в
                    повседневных ситуациях и на рабочем месте.
                    Он подходит для тех, кто уже имеет базовые
                    навыки и стремится к их улучшению, включая
                    грамматику, лексику и навыки общения.</p>
            </details>
            <details>
