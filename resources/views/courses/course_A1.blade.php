...
<section class="level">
        ...
        <div class="card_level" id="levelA1">
            <img src="{{ asset('/img/cours/levelA1.svg') }}" alt="">
        </div>
        ...
        <div class="purposes">
            ...
            <div class="purposes_right">
                ...
                <div class="purposes_card">
                    ...
                    <h3>Цель 1</h3>
                    <p>Освоение базовой лексики и грамматики
                        английского языка, необходимой для
                        ежедневной коммуникации</p>
                </div>
    ...
    <div class="container">
        ...
        <div class="faq-section">
            <details>
                ...
                <p>Этот курс идеально подходит для тех, кто только начинает изучать английский язык и хочет быстро и эффективно овладеть базовыми навыками чтения, письма, устной и письменной коммуникации.</p>
            </details>
            <details>
