...
<section class="level">
        ...
        <div class="card_level" id="levelC1">
          <img src="{{ asset('/img/cours/levelC1.svg') }}" alt="">
        </div>
        ...
        <div class="purposes">
            ...
            <div class="purposes_right">
                ...
                <div class="purposes_card">
                  ...
                  <h3>Цель 1</h3>
                    <p>Совершенствование грамматики и лексики для свободного общения</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_2.svg')}}" alt="">
                  <h3>Цель 2</h3>
                    <p>Развитие навыков анализа и интерпретации текстов</p>
                </div>

                <div class="purposes_card">
                  <img src="{{ asset('img/cours/purpose_3.svg')}}" alt="">
                  <h3>Цель 3</h3>
                    <p>Уверенное ведение дискуссий и переговоров</p>
                </div>
...
<section class="photo">
    <div class="wrapper">
      ...
      <img src="{{ asset('img/cours/photoC1.svg')}}" alt="">
...
<div class="wrapper">
    <section class="content">
        ...
        <div class="content_left">
            ...
            <p>Грамматика: сложные конструкции, согласование времён, условные предложения второго и третьего типа.<br>
                Лексика: бизнес, наука, политика, экология и т.д.<br>
                Устная практика: дискуссии, переговоры, публичные выступления.<br>
                Чтение: статьи, научные работы, книги.<br>
                Письмо: написание исследований, отчётов, проектов.<p>
