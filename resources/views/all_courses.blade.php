...
<head>
    ...
    <link rel="icon" href="/img/main/logo.svg" type="image/png">
            ...
            <div class="cards-container">
                ...
                <div class="cards4">
                    <div class="card" id="work">
                        <div class="cardtxt">
                            <img src="{{ asset('img/all_courses/work.svg') }}">
                            <h3>Для работы</h3>
                        </div>
                    ...
                    <div class="card" id="purpose">
                        <div class="cardtxt">
                            <img src="{{ asset('img/all_courses/purpose.svg') }}">
                            <h3>Знаю цель</h3>
                        </div>
...
<script src="{{ asset('js/all_courses.js') }}"></script>
