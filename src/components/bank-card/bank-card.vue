		...
		<div class="card-form">
							...
							<div class="card-item__top">
								...
								<div class="card-item__type">
									<transition name="slide-fade-up">
										<img v-if="getCardType" :src="`https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/${getCardType}.png`" :key="getCardType" alt="" class="card-item__typeImg">
									</transition>
								</div>
							</div>
									...
									<transition name="slide-fade-up">
										<div class="card-item__name" v-if="cardName.length">
											<transition-group name="slide-fade-right">
												<span class="card-item__nameItem" v-for="(n, $index) in cardName" :key="$index">{{n}}</span>
											</transition-group>
										</div>
			...
			<div class="card-form__inner">
				<div class="card-input">
					...
					<input type="text" id="cardNumber" class="card-input__input" v-model="cardNumber" @focus="focusInput" @blur="blurInput" data-ref="cardNumber" autocomplete="off">
				</div>
				<div class="card-input">
				...
				<div class="card-form__row">
					<div class="card-form__col">
						<div class="card-form__group">
							...
							<select class="card-input__input" id="cardMonth" v-model="cardMonth" @focus="focusInput" @blur="blurInput" data-ref="cardDate">
								<option value="" disabled>Month</option>
								<option v-for="n in 12" :value="n < 10 ? '0' + n : n" :key="n" :disabled="n < minCardMonth">
									{{ n < 10 ? '0' + n : n }}
								</option>
							</select>
							<select class="card-input__input" id="cardYear" v-model="cardYear" @focus="focusInput" @blur="blurInput" data-ref="cardDate">
								<option value="" disabled>Year</option>
								<option v-for="(n, $index) in 12" :value="$index + minCardYear" :key="$index">
									{{ $index + minCardYear }}
								</option>
							</select>
						</div>
...
export default {
	...
	methods: {
		...
		blurInput() {
			setTimeout(() => {
				if (!this.isInputFocused) this.focusElementStyle = null;
			}, 300);
