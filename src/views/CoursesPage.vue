...
export default {
	...
	setup() {
		...
		const firstImg              = '/cours/level' + group.toUpperCase() + '.svg';
		const secondImg             = '/cours/photo' + group.toUpperCase() + '.svg';
